...
export default function CategoryManagement() {
  ...
  return (
    <div>
      <div className="flex flex-col mx-2 pt-10 bg-dark lg:flex-row lg:flex-wrap">
        <h3 className="font-bold text-xl text-orange self-center pb-4 my-3 lg:text-center lg:w-full">
          Categories management
        </h3>
        <button
          type="button"
          className="w-44 h-10 m-2 rounded-3xl lg:absolute lg:top-0 lg:left-0 font-primary bg-[linear-gradient(90deg,_#FF8200_0%,_#FF2415_100%)]"
      ...
      <div className="flex flex-col min-h-screen bg-dark lg:flex-row lg:min-h-[1700px]">
      ...
      <div className="min-h-screen justify-center lg:justify-start bg-dark ">
