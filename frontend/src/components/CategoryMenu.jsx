    ...
    <div>
      {categories.length > 0 && (
        <>
          ...
          <div className="bg-lightBlue dark:bg-opacity-0 dark:backdrop-blur-md border-solid border-2 border-orange w-56 px-5 py-3 rounded-md flex flex-col gap-2 items-center fixed z-50 bottom-14 right-2 ">
